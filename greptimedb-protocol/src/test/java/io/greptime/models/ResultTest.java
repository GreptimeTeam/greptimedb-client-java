...
public class ResultTest {
    ...
    public void testMap() {
        ...
        final Result<QueryOk, Err> r3 = Result.ok(QueryOk.ok("my query", null));
        final Result<String, Err> r4 = r3.map(QueryOk::getQl);
        Assert.assertEquals("my query", r4.getOk());
    ...
    public void testMapErr() {
        ...
        final Result<WriteOk, Err> r3 = Result.err(Err.writeErr(400, new IllegalStateException("error test"), null, null));
