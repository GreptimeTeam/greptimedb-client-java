...
import org.greptimedb.common.util.Clock;
import org.greptimedb.common.util.Cpus;
import org.greptimedb.common.util.Ensures;
import org.greptimedb.common.util.ExecutorServiceHelper;
import org.greptimedb.common.util.MetricsUtil;
import org.greptimedb.common.util.NamedThreadFactory;
import org.greptimedb.common.util.ObjectPool;
import org.greptimedb.common.util.RefCell;
import org.greptimedb.common.util.SharedThreadPool;
import org.greptimedb.common.util.StringBuilderHelper;
import org.greptimedb.common.util.SystemPropertyUtil;
import org.greptimedb.common.util.ThreadPoolUtil;
import org.greptimedb.rpc.errors.ConnectFailException;
import org.greptimedb.rpc.errors.InvokeTimeoutException;
import org.greptimedb.rpc.errors.OnlyErrorMessage;
import org.greptimedb.rpc.errors.RemotingException;
import org.greptimedb.rpc.interceptors.ClientRequestLimitInterceptor;
import org.greptimedb.rpc.interceptors.ContextToHeadersInterceptor;
import org.greptimedb.rpc.interceptors.MetricInterceptor;
import org.greptimedb.rpc.limit.Gradient2Limit;
import org.greptimedb.rpc.limit.LimitMetricRegistry;
import org.greptimedb.rpc.limit.RequestLimiterBuilder;
import org.greptimedb.rpc.limit.VegasLimit;
...
public class GrpcClient implements RpcClient {
    ...
    @Override
    public <Req, Resp> Resp invokeSync(Endpoint endpoint, //
                                       Req request, //
                                       Context ctx, //
    ...
    private void attachErrMsg(Throwable err, //
                              String callType, //
                              String method, //
                              String target, //
                              long startCall, //
